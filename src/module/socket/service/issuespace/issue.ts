...
function getIssue(
    userId: string,
    {
        kanbanUUID,
        options,
    }: { kanbanUUID: string; options?: Partial<TIssueListData> }
) {
    const metaData =
    ...
    const sendData = makePacket(
        ...
        "getIssue",
        metaData
            ? { code: ResponseCode.ok, issues: metaData }
...
function createIssue(
    userId: string,
    {
        kanbanUUID,
        issueData,
    }: { kanbanUUID: string; issueData: Omit<TIssueData, "issueId"> }
) {
...
function updateIssue(
    userId: string,
    {
        kanbanUUID,
        issueData,
    }: { kanbanUUID: string; issueData: Partial<TIssueData> }
) {
...
function deleteIssue(
    userId: string,
    { kanbanUUID, issueUUID }: { kanbanUUID: string; issueUUID: string }
) {
