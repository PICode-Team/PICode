...
export const DefualtInput = ({ classes, setDefualtInput, defaultInput, type }: any) => {
    ...
    return <div className={classes.content}>
        ...
        <div className={classes.inputContent}>
                ...
                {upload ?
                    ...
                    <>
                        <div style={{ textAlign: "center" }}>
                            ...
                            <br />
                            <span >{type === "edit" ? "If you want change iamge, upload image" : "Drag and Drop Image or Click to upload Image"}</span>
                        </div>
                    </>}
            </div>
            <input
            ...
            <input placeholder="Input project Participane ex)test1,test2,test3... "
